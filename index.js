...
function getArtistByIndex(array, index) {
    console.log("Task 3: ", `The artist at index ${index} is ${array[index].name}`)
  }
...
function get20s(array){
  ...
  console.log("Task 4: ", filtered_array)
}
...
function lotsOfArt(array){
  ...
  console.log("Task 7: ", filtered_array)
}
